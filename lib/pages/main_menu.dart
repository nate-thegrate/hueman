...
class _MainMenuState extends State<MainMenu> {
  ...
  Widget build(BuildContext context) {
    () async {
      await sleep(0.05);
      if (!running) return;
      setState(() => hue = (hue + 1) % 360);
    }();
    final Color c = Color(bestColors[hue]);
    ...
    menuButton(Pages page, [String? text]) {
      return ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(backgroundColor: c, foregroundColor: Colors.black),
        child: Padding(
